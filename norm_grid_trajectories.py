...
for file in ['shannon', 'unique_langs']:
    ...
    df = gpd.read_file('W:\\maphel_langtime\\geopackage\\norm_{}_grid_history.gpkg'.format(file))
    ...
    fdf = gpd.read_file('w:\\maphel_langtime\\geopackage\\finpop_grid_history.gpkg')
    ...
    plt.savefig(r'W:\maphel_langtime\plots\grid_trajectory_norm_shannon.pdf', dpi=300,
                bbox_inches='tight')
    ...
    plt.savefig(r'W:\maphel_langtime\plots\grid_trajectory_norm_unique.pdf', dpi=300,
                bbox_inches='tight')